...
import { getOperatingSystems, getWorkloadProfiles, getFlavors } from '../../../k8s/selectors';
...
export const getFormFields = (basicSettings, namespaces, templates) => {
  ...
  return {
    ...
    imageSourceType: {
      ...
      choices: [PROVISION_SOURCE_PXE, PROVISION_SOURCE_URL, PROVISION_SOURCE_REGISTRY],
      required: true
    },
    registryImage: {
